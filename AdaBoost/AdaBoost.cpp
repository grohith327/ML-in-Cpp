...
int main(int argc, char** argv)
{
    ...
    if(arg4 == "perceptron")
    {
        const mlpack::perceptron::Perceptron<> percp;
        AdaBoost<> model(train_data, train_resp, numClasses, percp);
    ...
    {
        const mlpack::decision_stump::DecisionStump<> ds;
        AdaBoost<mlpack::decision_stump::DecisionStump<>> model(train_data, train_resp, numClasses, ds);
